                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <div class="dropdown">
                                    <input id="role" name="role" class="btn btn-success dropdown-toggle" href="#" role="button" id="dropdownMenuLink" value="Select A Role!" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                    <ul id="admin_cal_list" class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                        <li id="1" class="dropdown-item"><a href="#">admin</a></li>
                                        <li id="2" class="dropdown-item"><a href="#">inspector</a></li>
                                        <li id="3" class="dropdown-item"><a href="#">student</a></li>
                                    </ul>
                                </div>
                                @error('role')
                                <span class="invalid-feedback" role="alert">
...
@section('content-js-files')
    <script>
        jQuery(document).ready(function(){
            $(".dropdown-menu li a").on('click', function(){
                const selected_text = $(this).text();
                $(this).parents('.dropdown').find('.dropdown-toggle')[0].value = selected_text;
            });
        });
    </script>
@endsection
